...
public class GenContainerC<T extends ITransportable> implements ITransporter<T>, ITransportable {
...
/*
    ...
    public ITransporter<T> store(T item) {
        ...
        item.follow(this);
        return new Model.GenContainer<T>(capacity, maxWidth, maxLength, pickUpRange, position, direction, length, width, newHolder);
    }
    ...
    public Pair<T, ITransporter<T>> remove(RemovingMethod removingMethod) {
        ...
        Model.GenContainer<T> newGenContainer = new Model.GenContainer<T>(capacity, maxWidth, maxLength, pickUpRange, position, direction, length, width, newHolder);
